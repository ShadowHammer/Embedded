; ModuleID = '/home/aksel/Documents/VitisHLS/Greyscale/Assignment2/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_example_ir(%"class.hls::stream"* %inStream, %"class.hls::stream"* %outStream) local_unnamed_addr #0 {
entry:
  %inStream_copy = alloca %"class.hls::stream", align 512
  %outStream_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %inStream, %"class.hls::stream"* nonnull align 512 %inStream_copy, %"class.hls::stream"* %outStream, %"class.hls::stream"* nonnull align 512 %outStream_copy)
  call void @apatb_example_hw(%"class.hls::stream"* %inStream_copy, %"class.hls::stream"* %outStream_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %inStream, %"class.hls::stream"* nonnull align 512 %inStream_copy, %"class.hls::stream"* %outStream, %"class.hls::stream"* nonnull align 512 %outStream_copy)
  ret void
}
