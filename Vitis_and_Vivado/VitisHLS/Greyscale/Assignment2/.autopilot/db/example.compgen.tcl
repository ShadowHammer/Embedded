...
set id 1
set name example_am_addmul_9ns_8ns_12ns_21_4_1
...
set out_width 21
set exp (i0+i1)*i2
set arg_lists {i0 {9 0 +} i1 {8 0 +} s {10 0 +} i2 {12 0 +} p {21 0 +} c_expval {c} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename example_AXI_CPU_axilite \
			name example_AXI_CPU_s_axi \
			ports {$port_AXI_CPU} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler example_AXI_CPU_s_axi
}
