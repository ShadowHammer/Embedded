...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net Grey_Scale_0_outStream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins example_0/outStream]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins example_0/inStream]
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins example_0/s_axi_AXI_CPU]
  ...
  connect_bd_net -net Grey_Scale_0_interrupt [get_bd_pins example_0/interrupt] [get_bd_pins xlconcat_0/In7]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins example_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs example_0/s_axi_AXI_CPU/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs example_0/s_axi_AXI_CPU/Reg]
  exclude_bd_addr_seg -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg]
  ...
  exclude_bd_addr_seg -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs example_0/s_axi_AXI_CPU/Reg]
  exclude_bd_addr_seg -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg]
